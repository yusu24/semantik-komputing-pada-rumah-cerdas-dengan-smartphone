...
void setup() {
    ...
    wifiManager.setAPStaticIPConfig(IPAddress(10,0,1,9), IPAddress(10,0,1,9), IPAddress(255,255,255,0));

    //fetches ssid and pass from eeprom and tries to connect
    //if it does not connect it starts an access point with the specified name
    //here  "AutoConnectAP"
    //and goes into a blocking loop awaiting configuration
    wifiManager.autoConnect("AutoConnectRelay1");
    ...
    Firebase.setInt("Aktuator/Relay1/active", 1);
    Firebase.setString("Aktuator/Relay1/connection", "");
    Firebase.setInt("Aktuator/Relay1/data", 1);
    Firebase.setString("Aktuator/Relay1/dconnect", StartMilisString);
    Firebase.setString("Aktuator/Relay1/name", "Relay1");  
    Firebase.setString("Aktuator/Relay1/durasi", durasi);    
}

void loop() {
    durasi = "";
    int data = Firebase.getInt("Aktuator/Relay1/data");
